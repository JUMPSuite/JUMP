...
sub generate_peptide_theoretical_mass
{
...
# add the ion series function 	
	...
	my @ion_series_name = ('a', 'b', 'c', 'd', 'v', 'w', 'x', 'y', 'z','a++', 'b++', 'c++', 'd++', 'v++', 'w++', 'x++', 'y++', 'z++','a+++', 'b+++', 'c+++', 'd+++', 'v+++', 'w+++', 'x+++', 'y+++', 'z+++');
=heac	
	my @ion_series_used;
...
# add the charge state 
	...
	if($charge>3)
	{
		...
		{	
			...
			{
				push (@ion_series_used,$ion_series_name[$i+9]);
				push (@ion_series_used,$ion_series_name[$i+18]);
			}
		}
	}
####### 11/3/2014 #########################
...
########################
	...
	{
		push (@{$aa{$_}}, @{$spectrum{'mass'}{'term'}{$_}});
		push(@bb,@{$spectrum{'mass'}{'term'}{$_}});
	}
