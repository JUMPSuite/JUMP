...
#	else
#	{
		my \$consolidation = new Spiders::Consolidation2('-dta_file'=>\$dtafile,'-keepnum'=>\$params->{'ms2_consolidation'});
...
#	}
	...
	my \$searchfile = \$dtafile; # ------this part replaces the following search part------
	\$searchfile =~ s\/dta\/spout\/;
	my \$search = new Spiders::Search2();
	\$search->write_null_searchfile(\$searchfile);
	\$dtas->add_dta(\$dtafile); # ------this part replaces the following search part------
