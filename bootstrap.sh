...
conda create -y -p $PWD/conda -c conda-forge -c bioconda perl-mime-base64 perl-data-dumper perl-class-std perl-file-spec perl-pod-usage perl-class-std perl-file-spec perl-pod-usage perl-statistics-distributions perl-file-temp perl-excel-writer-xlsx perl-statistics-r perl-file-find perl-http-date perl-math-bigint perl-list-util perl-mime-base64 perl-getopt-long perl-data-dumper perl-parallel-forkmanager perl-clone perl-app-cpanminus
...
$PWD/conda/bin/cpanm File::Copy File::Basename Scalar::Util LWP::UserAgent Set::Partition Sys::Hostname
