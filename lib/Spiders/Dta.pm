...
require Exporter;
@ISA	 = qw(Exporter);
@EXPORT      = ();#qw(set_dta_file get_dta_file parse_dtafile_name get_scan_num get_charge process_dtafile write_dta_file set_prec_mz set_charge set_mz_int_hash get_prec_mz get_mz_int_hash get_mz_array get_int_array JumpExe  new  add_dta  print_dtas); 
